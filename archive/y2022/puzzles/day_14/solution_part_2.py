from archive.y2022.puzzles.day_14.load_inputs import Position, input_reader, InputType
from archive.y2022.puzzles.day_14.solution_part_1 import DrainingSandCave
